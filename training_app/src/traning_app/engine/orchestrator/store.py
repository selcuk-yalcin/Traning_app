...
class JobStore:
    ...
    def get(self, job_id: str) -> JobRecord | None:
        with self._lock:
            ...
            return JobRecord(
                ...
                audio_manifest=copy.deepcopy(rec.audio_manifest) if rec.audio_manifest else None,
    ...
    def set_audio_manifest(self, job_id: str, manifest: dict[str, Any]) -> None:
        def fn(rec: JobRecord) -> None:
            rec.audio_manifest = manifest

        self._mutate(job_id, fn)

    def set_mp4_path(self, job_id: str, path: str) -> None:
        def fn(rec: JobRecord) -> None:
            rec.mp4_path = path
